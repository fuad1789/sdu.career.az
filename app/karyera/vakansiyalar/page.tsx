...
export default function VakansiyalarPage() {
  ...
  >([
    ...
    },
    {
      ...
      duration: "3-6 ay",
      description:
        "Ferrum Capital-da back-end developer sahəsində təcrübə proqramı. Real layihələr üzərində işləmə imkanı, mentorluq dəstəyi və beynəlxalq təcrübə.",
      requirements: [
        "Bakalavr və ya Magistr tələbəsi",
        "Back-end developer bacarıqları (Python, JavaScript, SQL)",
        "İngilis dili bilikləri (B2+ səviyyə)",
        "Komanda işi bacarıqları",
      ],
      benefits: [
        ...
        "Google sertifikatı",
        "Mentorluq proqramı",
        "Tam zamanlı iş imkanı",
      ],
      postedDate: "26 Oktyabr 2025",
      deadline: "23 noyabr 2025",
      status: "Aktiv",
      applicationLink:
        "https://www.tecrube.az/vacancies/backend-developer-intern-1",
    },
    {
      id: "3",
