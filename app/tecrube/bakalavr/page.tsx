...
export default function BakalavrTecrubePage() {
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-sdu-blue to-blue-700 py-20">
      ...
      {/* Müraciət Bölməsi */}
      <section className="bg-sdu-blue py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-white text-sdu-blue px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
            Müraciət Et
          </button>
        </div>
      </section>
